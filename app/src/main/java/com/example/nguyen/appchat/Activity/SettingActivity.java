...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayImage = (CircleImageView) findViewById(R.id.set_avatar_cri);
        mName = (TextView) findViewById(R.id.set_username_txt);
        mStatus = (TextView) findViewById(R.id.set_status_txt);

        mStatusBtn = (Button) findViewById(R.id.set_chStatus_btn);
        mImageBtn = (Button) findViewById(R.id.set_chImage_btn);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
            ...
            if(requestCode == GALLERY_PICK && resultCode == RESULT_OK){
                ...
                Toast.makeText(SettingActivity.this, imagestr, Toast.LENGTH_LONG).show();
            ...
            if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(SettingActivity.this,thumb_filePath.getPath(), Toast.LENGTH_LONG).show();
