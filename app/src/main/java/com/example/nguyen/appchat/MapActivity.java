...
public class MapActivity extends AppCompatActivity  implements LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showlocationbtn = (Button) findViewById(R.id.map_sendlocation_btn);
    ...
    private void showMyLocation() {
        ...
        try {
            ...
            while(myLocation == null){
                // Lấy ra vị trí.myLocation = LocationServices.FusedLocationApi.getLastLocation(gac);
            }
        ...
        if (myLocation != null) {
            ...
            Leg = myLocation.getLongitude();
            LatLng latLng = new LatLng(Lat,Leg);
            ...
            showlocationbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String strl = str + Lat +" "+Leg;
                    Toast.makeText(MapActivity.this, strl, Toast.LENGTH_LONG).show();
                }
            });
        } else {
